...
class FavoriteScreen extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      currentFavorites: [
        {
          name: `Nick's sushi ${this.props.rerenderNum}`,
          liked: true,
          category: 'Restaurant',
          rating: 4.7,
        },
  ...
  componentDidMount = async () => {
    ...
    const businessesFound = await findFavorites();
  ...
  render() {
    return (
      <View
        ...
        {this.props.favoritedBusinesses &&
          this.mapFavorites(this.props.favoritedBusinesses)}
      </View>
    );
  }
}
