...
class BusinessesList extends React.Component {
  ...
  updateAllHearts = async () => {
    ...
    const liked = await axios.get(`${tokens.backendApi}/favorites/liked`);
          ...
          <ScrollView
            ...
            }}>
            {
              (results = this.props.businesses.map((business, id) => {
                return (
                  <BusinessCard
                    addFavoriteBusiness={this.props.addFavoriteBusiness}
                    ...
                    removeFavoriteBusiness={this.props.removeFavoriteBusiness}
                  />
                );
              }))
            }
